...
//                 if (_field[column, row] != 0)
//                 {
//                     if (_survival.Contains(GetBigNeighborCount(column, row, _radius).ToString()))
//                     {
//                         newField[column, row] = _field[column, row] + 1;
//                     }
//                 }
//                 else
//                 {
//                     if (_birth.Contains(GetBigNeighborCount(column, row, _radius).ToString()) && _field[column, row] == 0)
//                     {
//                         newField[column, row] = 1;
//                     }
//                 }
