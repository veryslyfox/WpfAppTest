...
//             {
//                 var c = SpecialMath.DotFromMandelbrotSet(x / 200.0 / _f / _f - _m, y / 200.0 / _f / _f, 0, new System.Numerics.Complex(0, 0)) * 8;
//                 Color color = HsvToRgb(c, (byte)c, (byte)c);
...
//         _bitmap.Unlock();
//     }
//     private void Tick2(object? sender, EventArgs args)
//     {
//         _bitmap.Lock();
//         for (int y = 0; y < _bitmap.PixelHeight; y++)
//         {
