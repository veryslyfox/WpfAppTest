...
//     public MainWindow()
//     {
//         _network = NeuralNetwork.GetRandomNetwork(0, 1, "3,3");
//         InitializeComponent();
...
//             _space[(int)point.X, (int)point.Y] = 1;
//         }
//         Thread.Sleep(1000);
//         _network = NeuralNetwork.GetRandomNetwork(-1, 1, "2,3");
//         _bitmap.Lock();
//         for (int y = 0; y < _bitmap.PixelHeight; y++)
//         {
//             for (int x = 0; x < _bitmap.PixelWidth; x++)
//             {
//                 Color color = _space[x, y] == 0 ? FromRgb(255, 255, 255) : FromRgb(0, 0, 0);
